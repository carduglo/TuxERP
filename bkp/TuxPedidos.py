...
class main:
    def __init__(self, master):
        ...
        self.l1.place(relx = 0.42, rely = 0.07)
        ...
        self.l2.place(relx = 0.42, rely = 0.42)
        ...
        self.botao_login.place(relx = 0.425, rely = 0.75)
...
#-------------------------------------------Separador----------------------------------------------------------------------
        ...
        self.label33 = Label(self.frame4, text = u"Referência", font = ('Ariel','15'))
        self.pp_soma = Entry(self.frame4, width = 15, font = ('Ariel','15'))
        

        self.label34 = Label(self.frame4, text = "P", font = ('Ariel','15'))
        self.p_soma = Entry(self.frame4, width = 15, font = ('Ariel','15'))
        

        self.label35 = Label(self.frame4, text = "M", font = ('Ariel','15'))
        self.m_soma = Entry(self.frame4, width = 15, font = ('Ariel','15'))
        

        self.label36 = Label(self.frame4, text = "G", font = ('Ariel','15'))
        self.g_soma = Entry(self.frame4, width = 15, font = ('Ariel','15'))
        

        self.label37 = Label(self.frame4, text = "GG", font = ('Ariel','15'))
        self.gg_soma = Entry(self.frame4, width = 15, font = ('Ariel','15'))

        self.label33c = Label(self.frame4, text = u"Cor", font = ('Ariel','15'))
        self.pp_cor_soma = Entry(self.frame4, width = 15, font = ('Ariel','15'))

        self.label34c = Label(self.frame4, text = u"Cor", font = ('Ariel','15'))
        self.p_cor_soma = Entry(self.frame4, width = 15, font = ('Ariel','15'))

        self.label35c = Label(self.frame4, text = u"Cor", font = ('Ariel','15'))
        self.m_cor_soma = Entry(self.frame4, width = 15, font = ('Ariel','15'))

        self.label36c = Label(self.frame4, text = u"Cor", font = ('Ariel','15'))
        self.g_cor_soma = Entry(self.frame4, width = 15, font = ('Ariel','15'))

        self.label37c = Label(self.frame4, text = u"Cor", font = ('Ariel','15'))
        self.gg_cor_soma = Entry(self.frame4, width = 15, font = ('Ariel','15'))
...
#--------------------------------------Aba Relatórios-------------------------------------------------------------------
    ...
    def tela_principal(self):
        ...
        self.pp_soma.place(relx = 0.28, rely = 0.14, relwidth = 0.10)
        self.label34.place(relx = 0.28, rely = 0.20)
        self.p_soma.place(relx = 0.28, rely = 0.24, relwidth = 0.10)
        self.label35.place(relx = 0.28, rely = 0.30)
        self.m_soma.place(relx = 0.28, rely = 0.34, relwidth = 0.10)
        ...
        self.label33c.place(relx = 0.44, rely = 0.10)        
        self.pp_cor_soma.place(relx = 0.44, rely = 0.14, relwidth = 0.10)
        self.label34c.place(relx = 0.44, rely = 0.20)
        self.p_cor_soma.place(relx = 0.44, rely = 0.24, relwidth = 0.10)
        self.label35c.place(relx = 0.44, rely = 0.30)
        self.m_cor_soma.place(relx = 0.44, rely = 0.34, relwidth = 0.10)
        self.label36c.place(relx = 0.44, rely = 0.40)
        self.g_cor_soma.place(relx = 0.44, rely = 0.44, relwidth = 0.10)
        self.label37c.place(relx = 0.44, rely = 0.50)
        self.gg_cor_soma.place(relx = 0.44, rely = 0.54, relwidth = 0.10)
    ...
    def cadastra(self):
        ...
        if ref == '':
            ...
            try:
                ...
                cur.execute("INSERT INTO estoque VALUES(?,?,?,?,?)", (ref, desc, qt, qt, qt))
...
#-------------------------------------Funções de Estoque----------------------------------------------------
    ...
    def entrada_estoque(self):
        ...
        pp = int(self.pp_soma.get())
        p  = int(self.p_soma.get())
        m  = int(self.m_soma.get())
